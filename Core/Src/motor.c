...
void encoder_init(void) {
    ...
    GPIOB->MODER &= ~(GPIO_MODER_MODER4_0 | GPIO_MODER_MODER5_0);		// PB4
    GPIOB->MODER |= (GPIO_MODER_MODER4_1 | GPIO_MODER_MODER5_1);		// PB5
...
void PI_update(void) {
    ...
    /// TODO: calculate error signal and write to "error" variable
		volatile int16_t error = (target_rpm * 2) - motor_speed;
